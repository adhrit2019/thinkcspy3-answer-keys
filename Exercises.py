...
# Note: Line 6 to 256 are part of Chapter 6
# Question 1
...
# Note: Line 260 to 328 is part of Chapter 8
# Question 7
def reverse(strng):
...
def remove_letter(letter, strng):
    """Returns a string with the removed letter."""
...
def is_palindrome(strng):
    """Returns True if strng is a palindrome, else False."""
    
    return reverse(strng) == strng


# Question 11
def count(sub_str, strng):
    """Returns the number of substrings occuring in a string."""

    ix = 0
    count = 0
    while ix != len(strng):
        if strng[ix:len(sub_str) + ix] == sub_str:
            count += 1
        ix += 1
    return count
...
# Question 12
def remove(sub_str, strng):
    """Returns the new string after removing the first occurence of the substring."""
    ix = 0
    new_str = ""
    while ix != len(strng):
        if strng.find(sub_str, ix) == ix:
            break
        new_str += strng[ix]
        ix += 1
...
# Question 13
def remove_all(sub_str, strng):
    """Returns the new string after removing all the occurances of the substring."""
...
def test_suite():
    ...
    # Tests of Chapter 6 Question 1
    test(turn_clockwise("N") == "E")
    test(turn_clockwise("W") == "N")
    test(turn_clockwise(42) == None)
    test(turn_clockwise("rubbish") == None)
    
    # Tests of Chapter 6 Question 2
    test(day_name(3) == "Wednesday")
    test(day_name(6) == "Saturday")
    test(day_name(42) == None)
    
    # Tests of Chapter 6 Question 3
    ...
    # Tests of Chapter 6 Question 4
    test(day_add("Monday", 4) == "Friday")
    test(day_add("Tuesday", 0) == "Tuesday")
    test(day_add("Tuesday", 14) == "Tuesday")
    test(day_add("Sunday", 100) == "Tuesday")
    
    # Tests of Chapter 6 Question 5
    test(day_add("Sunday", -1) == "Saturday")
    test(day_add("Sunday", -7) == "Sunday")
    test(day_add("Tuesday", -100) == "Sunday")
    
    # Tests of Chapter 6 Question 6
    test(days_in_month("February") == 28)
    test(days_in_month("December") == 31)
    test(days_in_month("Monday") == None)
    
    # Tests of Chapter 6 Question 7
    ...
    # Tests of Chapter 6 Question 8
    test(to_secs(2.5, 0, 10.71) == 9010)
    test(to_secs(2.433,0,0) == 8758)

    # Tests of Chapter 6 Question 9
    ...
    # Tests of Chapter 6 Question 11
    test(compare(5, 4) == 1)
    test(compare(7, 7) == 0)
    test(compare(2, 3) == -1)
    test(compare(42, 1) == 1)
    
    # Tests of Chapter 6 Question 12
    test(hypotenuse(3, 4) == 5.0)
    test(hypotenuse(12, 5) == 13.0)
    test(hypotenuse(24, 7) == 25.0)
    test(hypotenuse(9, 12) == 15.0)
    
    # Tests of Chapter 6 Question 13
    ...
    # Tests of Chapter 6 Question 14
    test(is_even(2))
    test(is_even(12))
    test(is_even(46))
    test(is_even(52))
    
    # Tests of Chapter 6 Question 15
    test(is_odd(1))
    test(is_odd(53))
    ...
    # Tests of Chapter 6 Question 16
    test(is_factor(3, 12))
    ...
    # Tests of Chapter 6 Question 17
    ...
    # Tests of Chapter 6 Question 18
    test(f2c(212) == 100)
    test(f2c(32) == 0)
    test(f2c(-40) == -40)
    test(f2c(36) == 2)
    ...
    # Tests of Chapter 6 Question 19
    test(c2f(0) == 32)
    test(c2f(100) == 212)
    test(c2f(-40) == -40)
    test(c2f(12) == 54)
    ...
    # Tests of Chapter 8 Question 7
    test(reverse("happy") == "yppah")
    test(reverse("Python") == "nohtyP")
    test(reverse("") == "")
    test(reverse("a") == "a")
    
    # Tests of Chapter 8 Question 8
    test(mirror("good") == "gooddoog")
    test(mirror("Python") == "PythonnohtyP")
    test(mirror("") == "")
    test(mirror("a") == "aa")
    
    # Tests of Chapter 8 Question 9
    ...
    # Tests of Chapter 8 Question 10
    ...
    # Tests of Chapter 8 Question 11
    ...
    # Tests of Chapter 8 Question 12
    test(remove("an", "banana") == "bana")
    test(remove("cyc", "bicycle") == "bile")
    test(remove("iss", "Mississippi") == "Missippi")
    test(remove("eggs", "bicycle") == "bicycle")
    
    # Tests of Chapter 8 Question 13
