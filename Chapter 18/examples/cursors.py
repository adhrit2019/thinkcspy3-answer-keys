...
t = ("oooooooooooooooooooooooooooooooo",
     "oooooooooooooooooooooooooooooooo",
     "oooxxxxxxxxxxxxxxxxxxxxxxooooooo",
     "ooxx,,,,,,,,,,,,,,,,,,,,xxoooooo",
     "ooxx,,,,,,,,,,,,,,,,,,,,xxoooooo",
     "oooxxxxxxxxxxxxxxxxxxxxxxooooooo",
     "oooooooooooox,,xoooooooooooooooo",
     "oooooooooooox,,xoooooooooooooooo",
     "oooooooooooox,,xoooooooooooooooo",
     "oooooooooooox,,xoooooooooooooooo",
     "oooooooooooox,,xoooooooooooooooo",
...
def TestCursor(arrow):
    ...
    for y in range(len(arrow)):
        ...
        if hotspot != None:
            break
    if hotspot == None:
        raise Exception(f"No hotspot specified for cursor {arrow}!")
    s2 = []
    for line in arrow:
